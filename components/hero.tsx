  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center pt-20">
        <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-balance max-w-4xl mx-auto">
          Helping Small Businesses Grow Smarter and Faster
        </h1>
        
        <p className="mt-6 text-lg sm:text-xl text-primary-foreground/80 max-w-2xl mx-auto text-pretty">
          Budget-friendly business consulting, marketing strategy, and research-based planning.
        </p>
